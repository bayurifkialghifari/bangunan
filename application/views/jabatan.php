                                    ...
                                    <tbody>
                                        ...
                                        foreach ($allData as $data) : ?>
                                            <tr>
                                                ...
                                                <td><?= $data['tanggal']; ?></td>
                                                <td>
                                                    <a href="<?= base_url(); ?>jabatan/detail/<?= $data['id_jabatan']; ?>" class="btn btn-success">Detail</a>
                                                    <a href="<?= base_url(); ?>jabatan/delete/<?= $data['id_jabatan']; ?>" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
